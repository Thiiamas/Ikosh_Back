...
import com.Thiiamas.SpringCourse.Repository.RoleRepository;
import com.Thiiamas.SpringCourse.Repository.UserRepository;
import com.Thiiamas.SpringCourse.Security.Services.UserDetailsImpl;
import com.Thiiamas.SpringCourse.Security.jwt.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signupRequest){
        ...
        if (userRepository.existsByEmail(signupRequest.getEmail())){
            return ResponseEntity.badRequest().body(
                    new MessageResponse("Error : Email already in use")
            );
        }
